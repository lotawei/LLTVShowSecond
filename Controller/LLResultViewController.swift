...
import UIKit
    let   cellid = "cell"
class LLResultViewController: BaseViewController ,SelectCategoriesPro,UITableViewDelegate,UITableViewDataSource ,LTMorphingLabelDelegate{
    ...
    override func viewDidLoad() {
        ...
        LLSearchResult.searchwithkey(strkey,{
            (result)  in
            tmp?.lblshow.removeFromSuperview()
            tmp?.resultheadview.setsearchresult(result)
