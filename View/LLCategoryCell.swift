...
class LLCategoryCell: UITableViewCell, UICollectionViewDelegate, UICollectionViewDataSource
{
    ...
    weak  var   delegate:ItemViewProDelegate?
...
//        
    ...
    func setcategory(_ category:LLContenCategory){
        ...
        var    itemurl = ""
        if  curcategry.code == "movie" || curcategry.code == "tv"||curcategry.code == "zongyi"||curcategry.code == "comic"||curcategry.code == "jilu"{
            
            itemurl = "http://open.moretv.com.cn/position/" + curcategry.code
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell{
        ...
        cell?.setitem(item)
//        cell?.addcollecttatrget(target: self, action: #selector(clickitem), events: .touchUpInside)
        return   cell!
    }
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
      
        
        if  delegate != nil && (delegate?.responds(to:#selector(ItemViewProDelegate.DidClickItemCell(_:_:_:))))!{
            
            
             delegate?.DidClickItemCell!(curcategry.title,recitems,indexPath)
